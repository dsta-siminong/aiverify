...
from noisy_label_algorithm.algo_init import AlgoInit
...
def parse_input_args():
    ...
    # Add additional arguments as needed
    parser.add_argument("--num_epochs", default=30, help="Indicate the feature name to be extracted from the data file.")
