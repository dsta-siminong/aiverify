"""
Allow tutorial_algorithm to be executable through `python3 -m tutorial_algorithm`.
"""
...
from tutorial_algorithm.plugin_init import run
...
def version_msg():
    ...
    return f"tutorial_algorithm - {version('tutorial_algorithm')} from \
