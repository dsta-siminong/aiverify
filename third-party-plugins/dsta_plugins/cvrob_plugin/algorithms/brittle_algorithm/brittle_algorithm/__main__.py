"""
Allow brittle_algorithm to be executable through `python3 -m brittle_algorithm`.
"""
...
from brittle_algorithm.plugin_init import run
...
def version_msg():
    ...
    return f"brittle_algorithm - {version('brittle_algorithm')} from \
