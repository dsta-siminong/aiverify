...
class AlgoInit:
    ...
    def _generate_output_file(self, results, output_path: Path) -> None:
        ...
        try:
            ...
            artifact_list = [
                "GaussianBlur/matplotlib/brittleness_top_k_gaussianblur.png",
                "GaussianBlur/plotly/brittleness_top_k_gaussianblur.html",
                "GaussianBlur/plotly/brittleness_carousel.html",
            ]
